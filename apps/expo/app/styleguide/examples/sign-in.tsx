...
export default function SignInExamplePage() {
  ...
  return (
    ...
    >
      <YStack gap="$6">
        <AnchorHeading id="sign-in-form" title="Form" description="Centered card with inputs and helper links." />
        <YStack borderWidth={1} borderColor="$color6" borderRadius="$4" padding="$5" maxWidth={360} gap="$3">
