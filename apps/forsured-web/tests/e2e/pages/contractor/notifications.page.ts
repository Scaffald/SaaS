// tests/e2e/pages/contractor/notifications.page.ts
import { Page, Locator, expect } from '@playwright/test';
import { BasePage } from '../base.page';

export class ContractorNotificationsPage extends BasePage {
  readonly url = '/subcontractor/notifications';
  ...
  readonly taskUpdates: Locator;
  readonly documentRequests: Locator;
  ...
  constructor(page: Page) {
    ...
    this.taskUpdates = page.locator('[data-testid="task-updates"], .task-updates');
    this.documentRequests = page.locator('[data-testid="document-requests"], .document-requests');
  ...
  async expectNotificationsVisible() {
    ...
    expect(await this.hasContent('notifications', 'notification', 'tasks', 'loading', 'welcome', 'forsured')).toBeTruthy();
  }
