// tests/e2e/pages/manager/notifications.page.ts
import { Page, Locator, expect } from '@playwright/test';
import { BasePage } from '../base.page';

export class ManagerNotificationsPage extends BasePage {
  readonly url = '/manager/notifications';
  ...
  readonly approvalRequests: Locator;
  ...
  constructor(page: Page) {
    ...
    this.approvalRequests = page.locator('[data-testid="approval-requests"], .approval-section');
  ...
  async expectNotificationsVisible() {
    ...
    expect(await this.hasContent('notifications', 'notification', 'approvals', 'loading')).toBeTruthy();
  }
