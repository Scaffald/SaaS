...
export class ManagerTasksPage extends BasePage {
  readonly url = '/manager/tasks';
  ...
  constructor(page: Page) {
    ...
    this.createButton = page.locator('button:has-text("Create"), button:has-text("New Task"), a:has-text("Create")');
