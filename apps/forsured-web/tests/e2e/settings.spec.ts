...
test.describe('Settings Pages', () => {
  ...
  test('Contractor can access profile settings', async ({ page }) => {
  ...
  test('Contractor can access company settings', async ({ page }) => {
    await setupAuthAs(page, 'active.contractor@test.forsured.com');
  ...
  test('Broker can access profile settings', async ({ page }) => {
  ...
  test('Broker can access agency settings', async ({ page }) => {
    await setupAuthAs(page, 'active.broker@test.forsured.com');
