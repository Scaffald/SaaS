...
test.describe('GC User Flow', () => {
  ...
  test('GC can view dashboard', async ({ page }) => {
...
test.describe('GC Page Structure', () => {
  ...
  test('Dashboard shows project management UI or empty state', async ({ page }) => {
    await page.goto('/manager/dashboard');
  ...
  test('Projects page shows project list or empty state', async ({ page }) => {
    await page.goto('/manager/projects');
