    ...
    return (
      <Stack gap={16}>
        <Stack>
          ...
          <Text>Track your compliance status and manage documents</Text>
        </Stack>
        <EmptyState
          icon={Briefcase}
      ...
      >
        <Row alignItems="center" justifyContent="space-between" style={{ marginBottom: 16 }}>
          <Stack>
            ...
            <Text>Your overall compliance health score</Text>
          </Stack>
        ...
        <Grid columns={{ base: 1, sm: 2, lg: 3 }} gap={16}>
          ...
          <Stack
            alignItems="center"
            padding={16}
            style={{ backgroundColor: 'var(--color-yellow-2)', borderRadius: 8 }}
          >
            <Clock color="var(--yellow10)" style={{ margin: '0 auto 8px' }} size={24} />
            <Text size="sm" weight="medium">
              2 Expiring Soon
            </Text>
            <Text size="sm" style={{ color: 'var(--color-yellow-10)' }}>
      ...
      <Grid columns={{ base: 1, sm: 2, lg: 4 }} gap={16}>
        ...
        >
          <Row alignItems="center" justifyContent="space-between">
            ...
            <Row padding={16} style={{ backgroundColor: 'var(--color-blue-3)', borderRadius: 24 }}>
              <FileText color="var(--blue10)" size={24} />
            </Row>
          </Row>
          <Text size="sm" style={{ marginTop: 16, color: 'var(--color-green-10)' }}>
            All verified
          </Text>
        </Card>
        ...
        >
          <Row alignItems="center" justifyContent="space-between">
            ...
            <Row padding={16} style={{ backgroundColor: 'var(--color-green-3)', borderRadius: 24 }}>
        ...
        >
          <Row alignItems="center" justifyContent="space-between">
            ...
            <Row
              padding={16}
              style={{ backgroundColor: 'var(--color-orange-3)', borderRadius: 24 }}
            >
              <AlertTriangle color="var(--orange10)" size={24} />
            </Row>
          </Row>
          <Text size="sm" style={{ marginTop: 16, color: 'var(--color-orange-10)' }}>
            Action required
          </Text>
        </Card>
          ...
          <Stack gap={16}>
            ...
            >
              <Row alignItems="center" gap={16}>
                ...
                <Text weight="medium">Shop Insurance</Text>
              </Row>
            ...
            >
              <Row alignItems="center" gap={16}>
                ...
                <Text weight="medium">Schedule Renewal</Text>
              </Row>
        ...
        >
          ...
          <Stack gap={16}>
            <Row alignItems="center" gap={16}>
              ...
              <Stack flex={1}>
                <Text size="sm">General Liability renewed</Text>
            ...
            <Row alignItems="center" gap={16}>
              ...
              <Stack flex={1}>
                <Text size="sm">License certificate uploaded</Text>
            ...
            <Row alignItems="center" gap={16}>
              ...
              <Stack flex={1}>
                <Text size="sm">Workers' comp expires in 30 days</Text>
