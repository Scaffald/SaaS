...
import { VALID_CATEGORIES, VALID_PRIORITIES, validateColor } from '../../lib/tasks/taskTypeService'
...
export default function TaskTypeForm({
  ...
  // Handle field change
  const handleChange = (field: keyof TaskTypeFormData, value: string | number | boolean) => {
        ...
        <Stack style={{ gap: 16 }}>
          ...
          <Grid columns={{ base: 1, sm: 2 }} gap={16}>
            <Select
              ...
              onChange={(e) => handleChange('default_priority', e.target.value as TaskPriority)}
              fullWidth
            />
