      ...
      <form onSubmit={handleSubmit}>
        <Stack style={{ gap: 16 }}>
          <Stack style={{ gap: 8 }}>
            ...
            />
            {errors.carrier && (
              <Text style={{ color: 'var(--color-red-10)', fontSize: 12 }}>{errors.carrier}</Text>
            )}
          </Stack>
          <Stack style={{ gap: 8 }}>
            <Text style={{ fontWeight: 600, color: 'var(--color-text)' }}>
            ...
            />
            {errors.glPolicyNumber && (
              <Text style={{ color: 'var(--color-red-10)', fontSize: 12 }}>
                {errors.glPolicyNumber}
              </Text>
            )}
          </Stack>
          ...
          <Stack style={{ marginTop: 24 }}>
            <Button onPress={handleSubmit} variant="primary" disabled={isLoading}>
