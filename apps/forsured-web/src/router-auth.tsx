          ...
          element={
            <ProtectedRoute requiredRole="subcontractor">
              <Routes>
                ...
                <Route
                  path="settings"
                  element={<Navigate to="/subcontractor/settings/profile" replace />}
                />
          ...
          element={
            <ProtectedRoute requiredRole="broker">
              <Routes>
                ...
                <Route
                  path="acknowledgements/:formId"
                  element={<BrokerAcknowledgementFormPage />}
                />
                <Route path="marketplace" element={<InsuranceMarketplace />} />
                <Route path="notifications" element={<NotificationsAndApprovalsPage />} />
                {/* Settings Routes */}
                <Route
                  path="settings"
                  element={<Navigate to="/broker/settings/profile" replace />}
                />
