...
const EnhancedManagerDashboard = lazy(
  () => import('./components/Dashboard/EnhancedManagerDashboard')
)
const EnhancedSubcontractorDashboard = lazy(
  () => import('./components/Dashboard/EnhancedSubcontractorDashboard')
)
...
const SubcontractorOnboarding = lazy(
  () => import('./components/Onboarding/SubcontractorOnboarding')
)
...
const ManagerAcknowledgementsList = lazy(
  () => import('./components/Manager/ManagerAcknowledgementsList')
)
...
const SubcontractorProjectsPage = lazy(
  () => import('./components/Subcontractor/SubcontractorProjectsPage')
)
...
const BrokerAcknowledgementFormPage = lazy(
  () => import('./components/BrokerAcknowledgement/BrokerAcknowledgementFormPage')
)
const BrokerAcknowledgementList = lazy(
  () => import('./components/BrokerAcknowledgement/BrokerAcknowledgementList')
)
...
const NotificationsAndApprovalsPage = lazy(
  () => import('./components/Notifications/NotificationsAndApprovalsPage')
)
const UserManagementPage = lazy(() => import('./components/User/UserManagementPage'))
const ClientProfilePage = lazy(() => import('./app/(dashboard)/clients/[clientId]/page'))
...
const ContractorInsuranceSettings = lazy(
  () => import('./pages/contractor/settings/InsuranceSettings')
)
const ContractorNotificationSettings = lazy(
  () => import('./pages/contractor/settings/NotificationSettings')
)
const ContractorDocumentSettings = lazy(
  () => import('./pages/contractor/settings/DocumentSettings')
)
...
const BrokerNotificationSettings = lazy(
  () => import('./pages/broker/settings/NotificationSettings')
)
...
// Privacy Settings (CCPA Compliance)
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        ...
        {/* Merge workflow - accessed after login when manual user match is detected */}
        ...
        /> */}
          ...
          />
          <Route
            path="manager/settings/integrations/procore/callback"
            element={
              <ProtectedRoute allowedTypes={['manager']}>
                <ProcoreCallback />
              </ProtectedRoute>
          ...
          {/* Privacy Settings (CCPA Compliance) - Accessible to all authenticated users */}
          <Route
