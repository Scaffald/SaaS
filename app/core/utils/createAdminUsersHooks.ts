...
export const createAdminUsersHooks =
  ...
  (organizationId?: string | null) => {
    ...
    type UpdateResult = AdminUsersApi['update']['useMutation'] extends (...args: unknown[]) => infer R
      ? R extends MutationResultLike
        ? R
        : never
      : never
    type VerifyResult = AdminUsersApi['verify']['useMutation'] extends (...args: unknown[]) => infer R
      ? R extends MutationResultLike
        ? R
        : never
      : never
    type RevokeResult = AdminUsersApi['revoke']['useMutation'] extends (...args: unknown[]) => infer R
      ? R extends MutationResultLike
        ? R
        : never
      : never
