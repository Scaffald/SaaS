...
export function ProfileSkillsRight() {
  ...
  const [confirmRemoveSkillId, setConfirmRemoveSkillId] = useState<
    string | null
  >(null);
  ...
  return (
    <Stack gap={16} flex={1}>
      ...
      >
        ...
        />
        <ModalContent>
          <Text>{`Are you sure you want to remove "${skillName}" from your profile?`}</Text>
        </ModalContent>
        <ModalActions
          primaryAction={{
            label: "Remove Skill",
          ...
          secondaryAction={{
            label: "Cancel",
            onPress: () => setConfirmRemoveSkillId(null),
          }}
        />
      </Modal>
      <DashboardWidget>
