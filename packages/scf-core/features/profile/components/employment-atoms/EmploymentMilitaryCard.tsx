...
import { MILITARY_STATUS_OPTIONS, profileEmploymentBaseSchema } from '@scf/supabase/client-types'
  ...
  const save = useCallback(
    (next: string[]) => {
      ...
      if (!result.success) {
        ...
        logger.warn('Discarded military status — payload failed validation', {
