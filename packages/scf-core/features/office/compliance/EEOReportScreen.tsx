...
const MOCK_JOB_GROUPS: JobGroupData[] = [
  {
    ...
    totalHired: 38,
    categories: [
      { category: 'hispanic', label: 'Hispanic/Latino', applications: 89, interviewed: 52, offers: 18, hired: 15, selectionRate: 16.9 },
      { category: 'white', label: 'White', applications: 78, interviewed: 48, offers: 12, hired: 10, selectionRate: 12.8 },
      { category: 'black', label: 'Black/African American', applications: 42, interviewed: 22, offers: 7, hired: 6, selectionRate: 14.3 },
      { category: 'asian', label: 'Asian', applications: 18, interviewed: 10, offers: 3, hired: 3, selectionRate: 16.7 },
      { category: 'native_american', label: 'Native American', applications: 8, interviewed: 4, offers: 2, hired: 2, selectionRate: 25.0 },
      { category: 'pacific_islander', label: 'Pacific Islander', applications: 5, interviewed: 3, offers: 1, hired: 1, selectionRate: 20.0 },
      { category: 'two_or_more', label: 'Two or More', applications: 5, interviewed: 3, offers: 1, hired: 1, selectionRate: 20.0 },
    ],
  },
  {
    ...
    totalHired: 22,
    categories: [
      { category: 'hispanic', label: 'Hispanic/Latino', applications: 48, interviewed: 28, offers: 8, hired: 7, selectionRate: 14.6 },
      { category: 'white', label: 'White', applications: 62, interviewed: 38, offers: 9, hired: 8, selectionRate: 12.9 },
      { category: 'black', label: 'Black/African American', applications: 28, interviewed: 14, offers: 4, hired: 4, selectionRate: 14.3 },
      { category: 'asian', label: 'Asian', applications: 10, interviewed: 6, offers: 1, hired: 1, selectionRate: 10.0 },
      { category: 'native_american', label: 'Native American', applications: 4, interviewed: 2, offers: 1, hired: 1, selectionRate: 25.0 },
      { category: 'pacific_islander', label: 'Pacific Islander', applications: 2, interviewed: 1, offers: 0, hired: 0, selectionRate: 0 },
      { category: 'two_or_more', label: 'Two or More', applications: 2, interviewed: 1, offers: 1, hired: 1, selectionRate: 50.0 },
    ],
  },
  {
    ...
    totalHired: 8,
    categories: [
      { category: 'hispanic', label: 'Hispanic/Latino', applications: 22, interviewed: 14, offers: 3, hired: 2, selectionRate: 9.1 },
      { category: 'white', label: 'White', applications: 38, interviewed: 26, offers: 4, hired: 4, selectionRate: 10.5 },
      { category: 'black', label: 'Black/African American', applications: 16, interviewed: 8, offers: 1, hired: 1, selectionRate: 6.3 },
      { category: 'asian', label: 'Asian', applications: 8, interviewed: 5, offers: 1, hired: 1, selectionRate: 12.5 },
      { category: 'native_american', label: 'Native American', applications: 2, interviewed: 1, offers: 0, hired: 0, selectionRate: 0 },
      { category: 'pacific_islander', label: 'Pacific Islander', applications: 1, interviewed: 0, offers: 0, hired: 0, selectionRate: 0 },
      { category: 'two_or_more', label: 'Two or More', applications: 2, interviewed: 1, offers: 0, hired: 0, selectionRate: 0 },
    ],
  },
]
                  ...
                  <Stack gap={12}>
                    <Row justify="space-between" align="center">
                      <Stack>
                        ...
                        <Text style={{ fontSize: 12, color: colors.text[theme].tertiary }}>
                          SOC {group.jobCode} • {group.totalApplications} applicants • {group.totalHired} hired
                        </Text>
                      </Stack>
                    </Row>
                    ...
                    <Stack gap={6}>
                      <Row gap={0} style={{ paddingHorizontal: 4 }}>
                        <Text style={{ flex: 2, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary }}>
                          Category
                        </Text>
                        <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>
                          Applied
                        </Text>
                        <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>
                          Interviewed
                      ...
                      {group.categories.map((cat) => (
                        ...
                        >
                          ...
                          <Text style={{ flex: 1, fontSize: 13, color: colors.text[theme].secondary, textAlign: 'center' }}>
                            {cat.applications}
                          </Text>
                          <Text style={{ flex: 1, fontSize: 13, color: colors.text[theme].secondary, textAlign: 'center' }}>
                            {cat.interviewed}
            ...
            <Stack gap={16} paddingTop={16}>
              ...
              <Card variant="glass" padding="md">
                <Stack gap={12}>
                  ...
                  <Row gap={0} style={{ paddingHorizontal: 4 }}>
                    <Text style={{ flex: 2, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary }}>Group</Text>
                    <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>Applied</Text>
                    <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>Hired</Text>
                    <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>Rate</Text>
                    <Text style={{ flex: 1, fontSize: 11, fontWeight: '600', color: colors.text[theme].tertiary, textAlign: 'center' }}>4/5ths</Text>
                  </Row>
                  {[
                    { label: 'Male', data: GENDER_SUMMARY.male, ratio: adverseImpactAnalysis.maleRatio },
                    { label: 'Female', data: GENDER_SUMMARY.female, ratio: adverseImpactAnalysis.femaleRatio },
                    { label: 'Non-Binary', data: GENDER_SUMMARY.nonBinary, ratio: adverseImpactAnalysis.nonBinaryRatio },
                  ].map((row) => (
                    <Row key={row.label} gap={0} style={{ paddingVertical: 6, paddingHorizontal: 4, borderRadius: 4, backgroundColor: colors.bg[theme].subtle }}>
                      <Text style={{ flex: 2, fontSize: 13, color: colors.text[theme].primary }}>{row.label}</Text>
                      <Text style={{ flex: 1, fontSize: 13, color: colors.text[theme].secondary, textAlign: 'center' }}>{row.data.applications}</Text>
                      <Text style={{ flex: 1, fontSize: 13, color: colors.text[theme].secondary, textAlign: 'center' }}>{row.data.hired}</Text>
                      <Text style={{ flex: 1, fontSize: 13, color: colors.text[theme].secondary, textAlign: 'center' }}>{row.data.rate.toFixed(1)}%</Text>
                        ...
                        return (
                          <Stack key={stage} gap={4}>
                            <Row justify="space-between">
                              <Text style={{ fontSize: 13, fontWeight: '500', color: colors.text[theme].primary }}>
                                {stage}
                              </Text>
                              <Text style={{ fontSize: 12, color: colors.text[theme].tertiary }}>
                                {total} total
                            ...
                            <Row gap={1} style={{ height: 24, borderRadius: 6, overflow: 'hidden' }}>
                              {group.categories.map((cat) => {
                                const value = cat[key]
