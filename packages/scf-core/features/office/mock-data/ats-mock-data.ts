...
export const mockApplications: MockApplication[] = [
  {
    ...
    candidate: {
      ...
      experience: [
        ...
        },
        {
          ...
          duration: '2016 - 2019',
          description: 'Residential and commercial electrical work. Obtained master license.',
        },
      ],
    },
    job: {
    ...
    notes: [
      ...
      },
      {
        ...
        content: 'Strong technical skills. Would be great for our commercial team.',
        rating: 5,
    ...
    messages: [
      ...
      },
      {
        ...
        content: "Hi John, thanks for reaching out! I'm available Thursday or Friday afternoon.",
      ...
      },
      {
        ...
        sender: 'recruiter',
        senderName: 'John Recruiter',
        content: "Perfect! Let's schedule for Friday at 2pm. I'll send a calendar invite.",
      ...
      experience: [
        {
          ...
          description: 'Managing $20M+ commercial construction projects. Led teams of 50+ workers.',
        },
        {
      ...
      experience: [
        {
          ...
          description: 'Residential and commercial plumbing. Working toward master license.',
        },
      ],
    },
    job: {
 ...
 */
export const getApplicationsByStatus = (status: ApplicationStatus): MockApplication[] => {
 ...
 */
export const mockSendMessage = (applicationId: string, content: string): MockApplication => {
  const app = mockApplications.find((a) => a.id === applicationId)
  if (!app) throw new Error('Application not found')
