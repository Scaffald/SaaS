  ...
  return (
    ...
    >
      <Stack
        ...
        marginTop={2}
      >
        {selected && <Stack width={10} height={10} borderRadius={5} backgroundColor="$blue10" />}
      </Stack>
      <Stack flex={1} gap={4}>
        <Text>{label}</Text>
        {description && <Text color="$gray11">{description}</Text>}
        ...
        <Stack gap={12}>
          ...
          {requestType === 'correction' ? (
            <Stack gap={8}>
              ...
              >
                <Text color={correctionDetails ? '$color12' : '$color10'}>
        ...
        <Stack gap={12}>
          ...
          {typeInfo.warning && (
            <Row
              ...
              borderColor="$red6"
            >
              <Text color="$red11">⚠️ {typeInfo.warning}</Text>
            </Row>
          )}
