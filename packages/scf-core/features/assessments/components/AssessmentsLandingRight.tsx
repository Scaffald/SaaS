...
export const AssessmentsLandingRight = () => {
  ...
  return (
    <DashboardWidget gap={gap.md} elevated>
      <Stack gap={gap.md}>
        <Stack gap={gap.xs}>
          <Text style={{ color: colors.text[t].secondary }}>Why assessments matter</Text>
        ...
        <Stack gap={gap.sm}>
          <Stack gap={gap.xs}>
            <Text style={{ color: colors.text[t].secondary }}>Build a complete profile</Text>
            <Text style={{ color: colors.text[t].secondary }}>
          ...
          <Stack gap={gap.xs}>
            <Text style={{ color: colors.text[t].secondary }}>Drive better matches</Text>
            <Text style={{ color: colors.text[t].secondary }}>
          ...
          <Stack gap={gap.xs}>
            <Text style={{ color: colors.text[t].secondary }}>Share actionable insights</Text>
            <Text style={{ color: colors.text[t].secondary }}>
