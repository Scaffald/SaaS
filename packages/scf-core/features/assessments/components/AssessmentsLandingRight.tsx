    ...
    <DashboardWidget gap={spacing.md} elevated>
      <Stack gap={spacing.md}>
        <Stack gap={spacing.xs}>
          <Text color="gray">Why assessments matter</Text>
          <Text color="gray">
        ...
        <Stack gap={spacing.sm}>
          <Stack gap={spacing.xs}>
            <Text color="gray">Build a complete profile</Text>
            <Text color="gray">
          ...
          <Stack gap={spacing.xs}>
            <Text color="gray">Drive better matches</Text>
            <Text color="gray">
          ...
          <Stack gap={spacing.xs}>
            <Text color="gray">Share actionable insights</Text>
            <Text color="gray">
