import type { CreateWorkLogInput, UpdateWorkLogInput, UploadWorkLogPhotoInput } from '@scf/schemas'
...
export type OfflineWorkLogPayload = OfflineWorkLogCreatePayload | OfflineWorkLogUpdatePayload
