...
export const ProgressIndicator = memo(function ProgressIndicator({
  ...
  return (
    <Stack gap={12} aria-live="polite">
      ...
      <ProgressBar value={completionPercentage} showLabel={false} showIndicator={false} showHintMessage={false} />
            ...
            return (
              <Row key={stepId} gap={8} align="center">
                <Stack
                  width={32}
                  height={32}
                  backgroundColor={isCurrent ? '#2563eb' : isCompleted ? '#16a34a' : '#ced2da'}
                  align="center"
                  justify="center"
                  borderRadius={12}
                  role="img"
