...
export const RouteBuilder = {
  ...
  communityDetail: (slug: string) => buildPath(ROUTES.COMMUNITIES.DETAIL, { slug }),
  communityMembers: (slug: string) => buildPath(ROUTES.COMMUNITIES.DETAIL.MEMBERS, { slug }),
  communityPostCreate: (slug: string) => buildPath(ROUTES.COMMUNITIES.DETAIL.POST.CREATE, { slug }),
