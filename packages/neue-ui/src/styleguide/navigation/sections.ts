    ...
    items: [
      {
        ...
        href: "/styleguide",
        description:
          "Start here for conventions, IA, and usage of the showcase.",
      ...
      },
      {
        ...
        description:
          "Machine-generated inventory of tech stack, tokens, and gaps.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "12-column responsive grid utilities mapped to media queries.",
      ...
      },
      {
        ...
        description:
          "Brand palette and status mappings for Bootstrap-style variants.",
        tags: ["palette"],
      },
      {
        title: "Utilities",
        ...
        description:
          "Spacing, display, and text helpers generated from tokens.",
        tags: ["helpers"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Boolean and multi-select controls with accessibility guidance.",
        tags: ["forms"],
      },
      {
        title: "Input Groups",
      ...
      },
      {
        ...
        description:
          "Interactive playground for complex composed form components.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Horizontal and vertical grouping with segmented control behaviour.",
        tags: ["cta", "layout"],
      },
      {
        title: "Dropdowns",
      ...
      },
      {
        ...
        description:
          "Offset and cursor pagination controls with size variants.",
        tags: ["nav"],
      },
      {
        title: "Labels & Badges",
    ...
    items: [
      {
        ...
        description:
          "Striped, bordered, and condensed variants built from DataTable.",
        tags: ["data"],
      },
      {
        title: "Lists",
      ...
      },
      {
        ...
        description:
          "Comprehensive chart catalogue leveraging @scaffald/neue-ui primitives.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Hover and click triggered overlays with arrow positioning.",
        tags: ["overlay"],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "WCAG alignment, focus management, and screen reader helpers.",
        tags: ["a11y"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        description:
          "Data-rich dashboard sample using cards, tables, and charts.",
        tags: ["layout", "example"],
      },
      {
