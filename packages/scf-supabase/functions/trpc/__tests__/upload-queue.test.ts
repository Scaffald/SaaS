 ...
 *
 * Run with: deno test --allow-all packages/scf-supabase/functions/trpc/__tests__/upload-queue.test.ts
 */
...
Deno.test({
  ...
  async fn() {
    ...
    const results = await queue.enqueueBatch([
      { file: createTestFile(), path: 'test/file1.pdf', contentType: 'application/pdf' },
      { file: createTestFile(), path: 'test/file2.pdf', contentType: 'application/pdf' },
      { file: createTestFile(), path: 'test/file3.pdf', contentType: 'application/pdf' },
    ])
    ...
    assertEquals(duration < 100, true, `Duration ${duration}ms should be < 100ms`)
...
Deno.test({
  ...
  async fn() {
    ...
    await queue.enqueueBatch([
      { file: createTestFile(), path: 'test/a.pdf', contentType: 'application/pdf' },
      { file: createTestFile(), path: 'test/b.pdf', contentType: 'application/pdf' },
    ])
...
Deno.test({
  ...
  async fn() {
    ...
    await queue.enqueueBatch([
      { file: createTestFile(), path: 'test/time1.pdf', contentType: 'application/pdf' },
      { file: createTestFile(), path: 'test/time2.pdf', contentType: 'application/pdf' },
      { file: createTestFile(), path: 'test/time3.pdf', contentType: 'application/pdf' },
    ])
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(maxConcurrent <= 3, true, `Max concurrent was ${maxConcurrent}, expected <= 3`)
  },
})
