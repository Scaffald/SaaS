 ...
 *
 * Usage:
 *   npx tsx packages/scf-supabase/seeds/forsured/seed-forsured.ts
 *
 * Prerequisites:
...
export async function clearForsuredTestData(): Promise<void> {
  ...
  for (const table of tables) {
    const { error } = await supabase.from(table.replace('forsured.', '')).delete().gte('id', '50000000-0000-0000-0000-000000000000').lte('id', '7fffffff-ffff-ffff-ffff-ffffffffffff');
  ...
  const { error: authError } = await supabase.auth.admin.deleteUser('50000000-0000-0000-0000-000000000001');
