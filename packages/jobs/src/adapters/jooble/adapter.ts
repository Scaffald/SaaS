...
export interface JoobleAdapterMetadata {
...
export interface JoobleAdapterConfig {
  keywords?: string[]
  location?: string
  radius?: number
  page: number
...
export function parseKeywords(raw?: string | string[]): string[] | undefined {
...
export function parseNumber(raw?: number | string | null): number | undefined {
...
export function parseSalary(raw?: string | null): string | undefined {
  if (!raw) return undefined
...
export function buildConfig(
  ...
  const defaults: JoobleAdapterConfig = {
