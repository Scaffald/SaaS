import type { IPIPDomain, IPIPQuestion } from '@app/core/features/personality-assessment/lib/ipip';
 ...
 */
export function groupQuestionsByDomain(questions: IPIPQuestion[]): Record<IPIPDomain, IPIPQuestion[]> {
