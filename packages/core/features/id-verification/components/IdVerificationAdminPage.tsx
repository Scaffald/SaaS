    ...
    <YStack flex={1} gap="$4">
      <YStack px="$4" gap="$3">
        <XStack gap="$3" flexWrap="wrap">
          {[
            { label: "Active badges", value: summary.active, color: "$green12" as GetThemeValueForKey<"color"> },
            { label: "Expired badges", value: summary.expired, color: "$orange12" as GetThemeValueForKey<"color"> },
            { label: "Revoked badges", value: summary.revoked, color: "$red12" as GetThemeValueForKey<"color"> },
            { label: "Total verifications", value: summary.total, color: "$color12" as GetThemeValueForKey<"color"> },
          ].map((item) => (
            <Card
              key={item.label}
              flex={1}
