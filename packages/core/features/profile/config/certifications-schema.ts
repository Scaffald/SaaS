  ...
  certifications: z
    .array(
      z.object({
        ...
        issuing_organization: z.string().min(
          1,
...
export type CertificationsProfileFormData = z.infer<
  typeof certificationsProfileSchema
>;

export const certificationsProfileDefaults: Partial<
  CertificationsProfileFormData
> = {
  certifications: [],
};
