...
export const timeEntrySchema = z
  .object({
    start: z.string().regex(TIME_24_HOUR, 'Invalid time format. Expected HH:MM in 24-hour format.'),
...
const baseWorkLogFieldsSchema = z.object({
  ...
  logDate: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Invalid date format. Expected YYYY-MM-DD.'),
...
export type WorkLogProjectMetadata = z.infer<typeof workLogProjectMetadataSchema>
...
export type WorkLogOverviewResponse = z.infer<typeof workLogOverviewResponseSchema>
...
export type WorkLogProjectRollupResponse = z.infer<typeof workLogProjectRollupResponseSchema>
...
export type WorkLogProjectAnalyticsResponse = z.infer<typeof workLogProjectAnalyticsResponseSchema>
...
export type PublicWorkLogsResponse = z.infer<typeof publicWorkLogsResponseSchema>
