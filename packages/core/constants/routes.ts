...
export const RouteBuilder = {
  // Office routes
  officeUsersEdit: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_WORKERS_EDIT, { id }),
  officeJobsEdit: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_JOBS_EDIT, { id }),
  officeUniversitiesEdit: (id: string | number) =>
    buildRoute(ROUTES.OFFICE_CMS_UNIVERSITIES_EDIT, { id }),
  officeTeamsEdit: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_TEAMS_EDIT, { id }),
  officeTeamsDetail: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_TEAMS_DETAIL, { id }),
  ...
  projectEdit: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_PROJECTS_EDIT, { id }),
  projectDetail: (id: string | number) => buildRoute(ROUTES.OFFICE_CMS_PROJECTS_DETAIL, { id }),
  ...
  dashboardBackgroundCheck: () => ROUTES.DASHBOARD_PROFILE_BACKGROUND_CHECK.path,
  dashboardBackgroundCheckInitiate: () => ROUTES.DASHBOARD_PROFILE_BACKGROUND_CHECK_INITIATE.path,
  dashboardBackgroundCheckDispute: (checkId: string | number) =>
    buildRoute(ROUTES.DASHBOARD_PROFILE_BACKGROUND_CHECK_DISPUTE, {
      checkId,
    }),
  dashboardProfileIdVerification: () => ROUTES.DASHBOARD_PROFILE_ID_VERIFICATION.path,

  // Dashboard routes
  dashboardUser: (userId: string | number) => buildRoute(ROUTES.DASHBOARD_USER, { userId }),
...
export const ROUTE_HIERARCHY: readonly RouteHierarchyNode[] = [
  {
    ...
    children: [
      ...
      {
        key: 'DASHBOARD_TEAMS',
        children: [{ key: 'DASHBOARD_TEAMS_INVITATIONS' }, { key: 'DASHBOARD_TEAM_DETAIL' }],
      },
      {
        key: 'DASHBOARD_WORK_LOGS',
        children: [{ key: 'DASHBOARD_WORK_LOGS_CREATE' }, { key: 'DASHBOARD_WORK_LOGS_DETAIL' }],
      },
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            children: [{ key: 'OFFICE_CMS_WELCOME_CREATE' }, { key: 'OFFICE_CMS_WELCOME_EDIT' }],
          },
          {
            key: 'OFFICE_CMS_WORKERS',
            children: [{ key: 'OFFICE_CMS_WORKERS_CREATE' }, { key: 'OFFICE_CMS_WORKERS_EDIT' }],
          },
          {
            key: 'OFFICE_CMS_JOBS',
            children: [{ key: 'OFFICE_CMS_JOBS_CREATE' }, { key: 'OFFICE_CMS_JOBS_EDIT' }],
          },
          {
          ...
          },
          {
            ...
            children: [
              { key: 'OFFICE_CMS_PROJECTS_CREATE' },
              {
                ...
                children: [{ key: 'OFFICE_CMS_PROJECTS_EDIT' }],
              },
            ],
          },
          {
      ...
      {
        key: 'OFFICE_SETTINGS',
        children: [{ key: 'OFFICE_SETTINGS_GEOGRAPHIC' }, { key: 'OFFICE_SETTINGS_STRIPE' }],
      },
    ],
  },
] as const
...
export const DASHBOARD_ROUTES = {
  ...
  PROFILE_BACKGROUND_CHECK_INITIATE: ROUTES.DASHBOARD_PROFILE_BACKGROUND_CHECK_INITIATE,
...
export function isAuthPath(path: string): boolean {
  return Object.values(ROUTES).some(
    (route) => 'isAuth' in route && route.isAuth === true && path.startsWith(route.path)
  )
}
