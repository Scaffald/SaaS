...
const useUserMock = vi.fn<[], MockUseUserState>(() => baseUseUserValue);
...
const buildUseUserReturn = (
  overrides: Partial<MockUseUserState>,
): MockUseUserState => ({
  ...baseUseUserValue,
  ...overrides,
});
...
describe("useProtectedRoute", () => {
  ...
  it("does not trigger timeout when suppressed", async () => {
    ...
    render(
      <TestComponent timeoutMs={50} suppressTimeout onLoadingChange={() => {}} />,
    );
