        ...
        <View style={styles.positionRow}>
          <Dropdown trigger="Bottom Right" position="bottom-right">
            <DropdownSection heading="Options">
              <DropdownItem
                checked={selected1 === '1'}
                onPress={() => setSelected1('1')}
              >
                Option 1
              </DropdownItem>
              <DropdownItem
                checked={selected1 === '2'}
                onPress={() => setSelected1('2')}
              >
                Option 2
              </DropdownItem>
            </DropdownSection>
          ...
          <Dropdown trigger="Bottom Left" position="bottom-left">
            <DropdownSection heading="Options">
              <DropdownItem
                checked={selected2 === '1'}
                onPress={() => setSelected2('1')}
              >
                Option 1
              </DropdownItem>
              <DropdownItem
                checked={selected2 === '2'}
                onPress={() => setSelected2('2')}
              >
                Option 2
              </DropdownItem>
            </DropdownSection>
        ...
        <View style={styles.positionRow}>
          <Dropdown trigger="Top Right" position="top-right">
            <DropdownSection heading="Options">
              <DropdownItem
                checked={selected3 === '1'}
                onPress={() => setSelected3('1')}
              >
                Option 1
              </DropdownItem>
              <DropdownItem
                checked={selected3 === '2'}
                onPress={() => setSelected3('2')}
              >
                Option 2
              </DropdownItem>
            </DropdownSection>
          ...
          <Dropdown trigger="Top Left" position="top-left">
            <DropdownSection heading="Options">
              <DropdownItem
                checked={selected4 === '1'}
                onPress={() => setSelected4('1')}
              >
                Option 1
              </DropdownItem>
              <DropdownItem
                checked={selected4 === '2'}
                onPress={() => setSelected4('2')}
              >
                Option 2
              </DropdownItem>
            </DropdownSection>
