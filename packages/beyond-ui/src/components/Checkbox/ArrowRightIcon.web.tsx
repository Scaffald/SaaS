...
export function ArrowRightIcon({ size = 16, color = '#141c25' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" role="img" aria-label="Collapse">
