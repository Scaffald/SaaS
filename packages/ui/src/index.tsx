...
// Explicit exports for layout components to ensure babel plugin detection
...
export { Card, CardFooter, CardBackground } from '@tamagui/card'
export type { CardProps, CardFooterProps } from '@tamagui/card'
// Import Tamagui's CardHeader with an alias to avoid naming conflicts
export { CardHeader as TamaguiCardHeader } from '@tamagui/card'
export type { CardHeaderProps as TamaguiCardHeaderProps } from '@tamagui/card'
