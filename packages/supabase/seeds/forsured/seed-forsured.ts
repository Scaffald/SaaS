...
export async function clearForsuredTestData(): Promise<void> {
  ...
  for (const table of tables) {
    const { error } = await supabase.from(table.replace("forsured.", ""))
      .delete().gte("id", "50000000-0000-0000-0000-000000000000").lte(
        "id",
...
export async function seedForsuredTestData(): Promise<void> {
  ...
  try {
    ...
    console.log(
      "Step 4/5: Seeding ForSured documents, policies & compliance...",
    );
