...
-- =========================================================
-- FORSURED ROLES (ensure org-scoped roles exist)
-- =========================================================
INSERT INTO forsured.roles (scope, name, description)
VALUES
  ('organization', 'owner', 'Organization owner with full access'),
  ('organization', 'admin', 'Organization administrator'),
  ('organization', 'member', 'Organization member'),
  ('platform', 'platform_admin', 'ForSured platform administrator')
ON CONFLICT (name) DO NOTHING;

-- =========================================================
-- FORSURED ROLE ASSIGNMENTS
-- Look up actual role IDs by name (they're auto-generated)
-- =========================================================
WITH roles AS (
  SELECT id, name FROM forsured.roles WHERE name IN ('owner', 'admin', 'member') AND scope = 'organization'
)
...
(VALUES
  ...
  ('admin', '50000000-0000-0000-0000-000000000031', '60000000-0000-0000-0000-000000000001'),
  -- Test user organizations
  ('owner', '10000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000031'),
  ('owner', '10000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000032'),
  ('owner', '10000000-0000-0000-0000-000000000003', '60000000-0000-0000-0000-000000000033')
) AS ra(role_name, user_id, org_id)
WHERE r.name = ra.role_name;
