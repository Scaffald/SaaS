...
import communityPostsRouter from './routes/community-posts.ts'
import communityCommentsRouter from './routes/community-comments.ts'
import communityRatingsRouter from './routes/community-ratings.ts'
import communityInteractionsRouter from './routes/community-interactions.ts'
import communityReputationRouter from './routes/community-reputation.ts'
import communitySkillsRouter from './routes/community-skills.ts'
...
import { rateLimitMiddleware, trackApiKeyUsage } from './middleware/usage-tracker.ts'
...
app.route('/v1/communities', communitiesRouter) // Community hub (list, join, leave, members)
app.route('/v1/communities/posts', communityPostsRouter) // Community posts (CRUD, feed, submit, publish)
app.route('/v1/communities/comments', communityCommentsRouter) // Community comments (CRUD, pin/unpin)
app.route('/v1/communities/ratings', communityRatingsRouter) // Community ratings (rate, list, summary)
app.route('/v1/communities/interactions', communityInteractionsRouter) // Upvotes + bookmarks
app.route('/v1/communities/reputation', communityReputationRouter) // Scaffold Score + karma
app.route('/v1/communities/skills', communitySkillsRouter) // Skill taxonomy (search, tree, ancestors)
