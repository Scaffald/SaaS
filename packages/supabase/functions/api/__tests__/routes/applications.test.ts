...
import { markTestStart, registerUserWithMagicLink, createAdminClient } from '../setup.ts'
...
Deno.test('POST /v1/applications - returns 409 for duplicate application', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-duplicate@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications - returns 400 if job not published', async () => {
  ...
  assertErrorResponse(response)
  assert(response.body.message?.toLowerCase().includes('not accepting applications'))
...
Deno.test('GET /v1/applications/:id - returns 403 if not owner', async () => {
  ...
  const user2 = await registerUserWithMagicLink('test-app-notowner@example.com')
  ...
  assert(response.body.message?.toLowerCase().includes('your own applications'))
...
Deno.test('PATCH /v1/applications/:id - returns 403 if not owner', async () => {
  ...
  const user1 = await registerUserWithMagicLink('test-app-update-owner@example.com')
  const user2 = await registerUserWithMagicLink('test-app-update-notowner@example.com')
  assert(user1 !== null && user2 !== null)
...
Deno.test('PATCH /v1/applications/:id - returns 400 if status not pending/reviewing', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-update-rejected@example.com')
  assert(user !== null)
...
Deno.test('PATCH /v1/applications/:id - allows update for reviewing status', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-update-reviewing@example.com')
  assert(user !== null)
...
Deno.test('PATCH /v1/applications/:id - returns 404 if not found', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-update-404@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - withdraws application successfully', async () => {
  ...
  const client = createTestClient({ authToken: user.token })
  const response = await client.post(`/v1/applications/${application.id}/withdraw`, {
...
Deno.test('POST /v1/applications/:id/withdraw - allows withdrawal without reason', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-noreason@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - allows withdrawal from reviewing status', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-reviewing@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - allows withdrawal from inquired status', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-inquired@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - returns 403 if not owner', async () => {
  ...
  const user1 = await registerUserWithMagicLink('test-app-withdraw-owner@example.com')
  const user2 = await registerUserWithMagicLink('test-app-withdraw-notowner@example.com')
  assert(user1 !== null && user2 !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - returns 400 if already withdrawn', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-already@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - returns 400 if status is hired', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-hired@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - returns 400 if status is rejected', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-rejected@example.com')
  assert(user !== null)
...
Deno.test('POST /v1/applications/:id/withdraw - returns 404 if not found', async () => {
  ...
  const user = await registerUserWithMagicLink('test-app-withdraw-404@example.com')
  assert(user !== null)
