...
export async function rateLimitMiddleware(c: Context, next: Next) {
  ...
  const limit = limits[apiKey.rateLimitTier as keyof typeof limits] ||
    limits.free;
    ...
    return c.json(
      {
        ...
        message:
          `You have exceeded the rate limit of ${limit} requests per minute for your ${apiKey.rateLimitTier} tier`,
        limit,
