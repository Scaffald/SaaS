...
function normalizeProgress(
  ...
  const currentStep = currentStepCandidate &&
      PROFILE_WIZARD_STEPS.includes(currentStepCandidate)
  ...
  return {
    ...
    lastSavedAt:
      partialProgress.lastSavedAt ?? profileWizardDefaultProgress.lastSavedAt,
    requiredSteps: PROFILE_WIZARD_REQUIRED_STEPS,
    stepData: mergedStepData,
    completedAt:
      partialProgress.completedAt ?? profileWizardDefaultProgress.completedAt,
  };
}
