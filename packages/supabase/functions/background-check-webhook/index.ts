...
async function handleEvent(
  ...
  const previousMetadata =
    typedCheck.metadata && typeof typedCheck.metadata === "object"
      ? (typedCheck.metadata as Record<string, unknown>)
      : {};
  const previousNationSearch =
    previousMetadata?.nationsearch && typeof previousMetadata.nationsearch === "object"
      ? (previousMetadata.nationsearch as Record<string, unknown>)
      : {};

  updates.metadata = mergeMetadata(typedCheck.metadata, {
    nationsearch: {
