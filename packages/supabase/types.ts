...
> pnpm env-local pnpx supabase --workdir packages gen types typescript --local


> scaffald@ env-local /Users/clay/Development/SCF-Neue
> dotenv -e .env -- pnpx supabase --workdir packages gen types typescript --local
...
export type Database = {
  ...
  public: {
      ...
      application_messages: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["author_user_id"]
            isOneToOne: false
            referencedRelation: "v_applications_with_user_profiles"
    ...
    Views: {
      ...
      v_applications_with_user_profiles: {
        Row: {
          application_score: number | null
          applied_at: string | null
          attachments: Json | null
          ...
          job_id: string | null
          job_id_full: string | null
          job_location: string | null
          job_organization_id: string | null
          job_remote_option: string | null
