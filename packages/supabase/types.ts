    ...
    Tables: {
      ...
      oauth_clients: {
        Row: {
          ...
          registration_type:
            Database["auth"]["Enums"]["oauth_registration_type"];
          updated_at: string;
        };
        Insert: {
          client_name?: string | null;
    ...
    Tables: {
      ...
      background_check_access_log: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "background_check_access_log_accessed_by_user_id_fkey";
          ...
          {
            foreignKeyName:
              "background_check_access_log_background_check_id_fkey";
      ...
      background_check_disputes: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "background_check_disputes_background_check_id_fkey";
            columns: ["background_check_id"];
            isOneToOne: false;
            referencedRelation: "background_checks";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName:
              "background_check_disputes_resolved_by_user_id_fkey";
      ...
      background_check_documents: {
        ...
        Relationships: [
          {
            foreignKeyName:
              "background_check_documents_background_check_id_fkey";
            columns: ["background_check_id"];
            isOneToOne: false;
            referencedRelation: "background_checks";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName:
              "background_check_documents_uploaded_by_user_id_fkey";
          ...
          {
            foreignKeyName:
              "background_check_documents_verified_by_user_id_fkey";
      ...
      background_checks: {
        ...
        Insert: {
          ...
          package_id?: string | null;
          paid_by?:
            | Database["core"]["Enums"]["background_check_paid_by"]
            | null;
          payment_id?: string | null;
          pre_adverse_action_sent_at?: string | null;
          processing_started_at?: string | null;
      ...
      team_activity_events: {
        Row: {
          ...
          created_at: string;
          event_type:
            | Database["core"]["Enums"]["team_activity_event_type"]
            | string;
          id: string;
          occurred_at: string;
          organization_id: string;
