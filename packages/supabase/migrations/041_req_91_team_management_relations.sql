...
-- =========================================================
ALTER TABLE core.teams DROP CONSTRAINT IF EXISTS teams_default_role_id_fkey;
...
ALTER TABLE core.teams DROP CONSTRAINT IF EXISTS teams_updated_by_fkey;
ALTER TABLE core.teams
  ADD CONSTRAINT teams_updated_by_fkey
  FOREIGN KEY (updated_by) REFERENCES core.users(id) ON DELETE SET NULL;

ALTER TABLE core.teams DROP CONSTRAINT IF EXISTS teams_archived_by_fkey;
ALTER TABLE core.teams
...
-- =========================================================
ALTER TABLE core.team_roles DROP CONSTRAINT IF EXISTS team_roles_organization_id_fkey;
...
ALTER TABLE core.team_roles DROP CONSTRAINT IF EXISTS team_roles_created_by_fkey;
ALTER TABLE core.team_roles
  ADD CONSTRAINT team_roles_created_by_fkey
  FOREIGN KEY (created_by) REFERENCES core.users(id) ON DELETE SET NULL;

ALTER TABLE core.team_roles DROP CONSTRAINT IF EXISTS team_roles_updated_by_fkey;
ALTER TABLE core.team_roles
...
ALTER TABLE core.team_role_permissions DROP CONSTRAINT IF EXISTS team_role_permissions_role_id_fkey;
ALTER TABLE core.team_role_permissions
  ADD CONSTRAINT team_role_permissions_role_id_fkey
  FOREIGN KEY (role_id) REFERENCES core.team_roles(id) ON DELETE CASCADE;

ALTER TABLE core.team_role_permissions DROP CONSTRAINT IF EXISTS team_role_permissions_created_by_fkey;
ALTER TABLE core.team_role_permissions
  ADD CONSTRAINT team_role_permissions_created_by_fkey
  FOREIGN KEY (created_by) REFERENCES core.users(id) ON DELETE SET NULL;

ALTER TABLE core.team_role_permissions DROP CONSTRAINT IF EXISTS team_role_permissions_updated_by_fkey;
ALTER TABLE core.team_role_permissions
...
ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_team_id_fkey;
ALTER TABLE core.team_invitations
  ADD CONSTRAINT team_invitations_team_id_fkey
  FOREIGN KEY (team_id) REFERENCES core.teams(id) ON DELETE CASCADE;

ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_organization_id_fkey;
ALTER TABLE core.team_invitations
  ADD CONSTRAINT team_invitations_organization_id_fkey
  FOREIGN KEY (organization_id) REFERENCES core.organizations(id) ON DELETE CASCADE;

ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_inviter_user_id_fkey;
ALTER TABLE core.team_invitations
...
ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_invitee_user_id_fkey;
ALTER TABLE core.team_invitations
...
ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_role_id_fkey;
ALTER TABLE core.team_invitations
  ADD CONSTRAINT team_invitations_role_id_fkey
  FOREIGN KEY (role_id) REFERENCES core.team_roles(id) ON DELETE SET NULL;

ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_created_by_fkey;
ALTER TABLE core.team_invitations
  ADD CONSTRAINT team_invitations_created_by_fkey
  FOREIGN KEY (created_by) REFERENCES core.users(id) ON DELETE SET NULL;

ALTER TABLE core.team_invitations DROP CONSTRAINT IF EXISTS team_invitations_updated_by_fkey;
ALTER TABLE core.team_invitations
