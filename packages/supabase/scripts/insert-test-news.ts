    ...
    const testArticles = [
      {
        ...
        description: "The construction sector continues to show robust growth with new infrastructure projects driving demand for skilled workers across multiple regions.",
      ...
      },
      {
        ...
        description: "Updated OSHA guidelines require enhanced safety protocols on all construction sites, with emphasis on fall protection and equipment maintenance.",
      ...
      },
      {
        ...
        description: "From AI-powered project management to drone surveying, new technologies are revolutionizing how construction projects are planned and executed.",
      ...
      },
      {
        ...
        description: "New apprenticeship programs and training initiatives aim to attract more workers to the construction industry and address the ongoing labor shortage.",
      ...
      },
      {
        ...
        description: "Eco-friendly materials and green building practices are becoming standard as the industry moves toward more sustainable construction methods.",
