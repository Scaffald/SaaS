#!/usr/bin/env node
/**
 * Generate descriptions for all remaining tickets
 * Run this to generate descriptions, then update tickets via MCP
 */
...
const allTickets = [
  { id: '51f8e9a9-04b8-45a4-b766-077a8a381b63', title: 'admin-route-explore-036: /office/universities/:id/edit' },
  { id: '17f2b8b5-750a-487b-8702-b6025663aa87', title: 'admin-route-explore-035: /office/universities' },
  { id: '02a334d5-5bf1-4ae2-94e4-c06745b77529', title: 'admin-route-explore-034: /office/organizations/create' },
  { id: 'd9551cd1-0185-4389-8b12-388fb9485d62', title: 'admin-route-explore-033: /office/organizations/:id/edit' },
  { id: '390df9a7-4dcf-4617-9ec7-370252d1ac6f', title: 'admin-route-explore-032: /office/organizations' },
  { id: '8697c8a5-4382-4362-8ead-a94d46fedbda', title: 'admin-route-explore-031: /office/jobs/create' },
...
fs.writeFileSync('/tmp/all-ticket-updates.json', JSON.stringify(updates, null, 2));

console.log(`Generated ${updates.filter(u => u.success).length} descriptions`);
console.log(`Saved to /tmp/all-ticket-updates.json`);
console.log(`\nTo update tickets, use vibe-kanban MCP update_task with each description.`);
