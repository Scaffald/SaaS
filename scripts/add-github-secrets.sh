...
echo "Adding EXPO_PUBLIC_MAPBOX_STYLE_URL..."
echo "$EXPO_PUBLIC_MAPBOX_STYLE_URL" | gh secret set EXPO_PUBLIC_MAPBOX_STYLE_URL

echo "Adding EXPO_PUBLIC_MAPBOX_API_URL..."
echo "$EXPO_PUBLIC_MAPBOX_API_URL" | gh secret set EXPO_PUBLIC_MAPBOX_API_URL
