...
-- Verify industries
SELECT 'Industries Count:' as info, COUNT(*) as count FROM core.industries;
...
SELECT 'Industries:' as table_name, COUNT(*) as count FROM core.industries
UNION ALL
SELECT 'Super Admins:', COUNT(*) FROM core.role_assignments ra
  JOIN core.roles r ON r.id = ra.role_id
