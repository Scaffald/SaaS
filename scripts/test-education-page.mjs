...
async function captureEducationPage() {
  ...
  try {
    ...
    await page.goto('http://localhost:8082/dashboard/profile/education', { waitUntil: 'domcontentloaded' })
    await page.waitForTimeout(3000)
    
    console.log('Current URL:', page.url())
    
    // Take screenshot
    await page.screenshot({ path: '.playwright-mcp/admin-015-dashboard-profile-education.png', fullPage: true })
