#!/usr/bin/env node
/**
 * Bulk update script - generates descriptions for all remaining tickets
 * Run this, then use the generated descriptions to update tickets via MCP
 */
...
fs.writeFileSync('/tmp/remaining-updates.json', JSON.stringify(updates, null, 2));
console.log(`\nSaved to /tmp/remaining-updates.json`);
