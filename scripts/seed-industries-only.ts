...
const industries = [
  {
    slug: 'construction',
    name: 'Construction',
    description: 'Residential and commercial building trades',
  },
  {
    slug: 'manufacturing',
    name: 'Manufacturing',
    description: 'Industrial fabrication and assembly',
  },
  {
    slug: 'transportation',
    name: 'Transportation',
  ...
  },
  {
    slug: 'energy',
    name: 'Energy',
    description: 'Utilities, renewables, and field services',
  },
]
...
async function main() {
  ...
  // Verify
  const { data, error } = await supabase.schema('core').from('industries').select('*')
