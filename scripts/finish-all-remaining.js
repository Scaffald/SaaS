#!/usr/bin/env node
/**
 * Script to generate descriptions for all remaining tickets and update them via MCP
 */
...
// Save to JSON for use with MCP updates
const output = {
...
fs.writeFileSync('/tmp/all-remaining-updates.json', JSON.stringify(output, null, 2));
console.log(`\n✅ Saved all descriptions to /tmp/all-remaining-updates.json`);
console.log(`\nReady to update tickets via MCP!`);
