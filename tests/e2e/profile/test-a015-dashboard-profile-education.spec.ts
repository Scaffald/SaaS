...
test.describe('Admin • /profile/experience (Education)', () => {
  ...
  test('education level dropdown contains all 9 education levels', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('displays university/institution autocomplete field', async ({ page }: { page: Page }) => {
    ...
    const hasEmptyState =
      pageContent.includes('No education') || pageContent.includes('Add your first')
  ...
  test('shows empty state when no education history exists', async ({ page }: { page: Page }) => {
    ...
    const hasEmptyState =
      pageContent.includes('No education') ||
      pageContent.includes('Add your first') ||
      pageContent.includes('not saved yet')
    const hasEducationEntries =
      pageContent.includes('Education 1') ||
  ...
  test('displays two-panel layout with form and education display', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('date inputs accept YYYY-MM-DD format', async ({ page }: { page: Page }) => {
    ...
    const hasDatePlaceholder =
      pageContent.includes('YYYY-MM-DD') ||
  ...
  test('displays formatted dates in right panel education display', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('supports "currently enrolled" or "Present" for end date', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('displays numbered education entries (Education 1, 2, etc.)', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('uses appropriate select UI for platform (sheets on mobile)', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('displays education cards with proper formatting in right panel', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('shows graduation cap icon when no education entries exist', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('displays institution name prominently in education cards', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('displays calendar icon for dates and mappin icon for location', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('handles error state when education data fails to load', async ({
    page,
  }: {
    page: Page
  }) => {
