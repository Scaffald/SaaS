...
test.describe('REQ-71: Branding Update - Scaffald Score', () => {
  ...
  test('should not contain any "Elevate Score" text in user-facing components', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('should display "Scaffald Score" in worker preview modal', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('should display "Scaffald Score" in user profile header', async ({
    page,
  }: {
    page: Page
  }) => {
  ...
  test('should display "Scaffald Score" filter label in discovery', async ({
    page,
  }: {
    page: Page
  }) => {
